...
export default {
  ...
  m_packs: "Packs",
  m_customPacks: "My packs",
  m_card: "Card",
  m_packMustBe100: "Every card must add up to exactly 100%",
  m_packNeedName: "Give the pack a name",
  m_deletePack: "Delete this pack?",
  ...
  t_mileOne50: "1 Mile 50/50",
  t_mileOne60: "1 Mile 60/40",
  t_damValley: "Dam Valley Run",
  t_damExtended: "Dam Extended Tour",
  t_damRally: "Dam Rallycross",
  t_damRun: "Dam Run",
  t_damTwisty: "Dam Twisty Road",
  t_damTwisty2: "Dam Twisty Road 2",
  t_damView: "Dam View",
  t_fast60: "Fast Circuit 60/40",
  t_maliAll: "Malibu All The Way Down",
  t_maliTour: "Malibu Beach Tour",
  t_maliUp: "Malibu Beach Uphill",
  t_maliCave: "Malibu Cave Driving",
  t_maliHairpin: "Malibu Downhill Hairpin",
  t_maliFast: "Malibu Fast Circuit",
  t_maliLong: "Malibu Long Beach",
  t_maliObserv: "Malibu Observatory",
  t_maliTcircuit: "Malibu Twisty Circuit",
  t_mixedDrag: "Mixed Drag",
  t_mojAround: "Mojave Around Town",
  t_mojCircuit: "Mojave Circuit",
  t_mojCross: "Mojave Cross Town",
  t_mojExtended: "Mojave Extended Tour",
  t_mojOver: "Mojave Over & Under",
  t_mojSlalom: "Mojave Slalom",
  t_mojSmall: "Mojave Small Town",
  t_mojSmallDesert: "Mojave Small Town Desert",
  ...
  t_palside: "Palmdale Beachside",
  t_palside2: "Palmdale Beachside 2",
  t_palCircuit: "Palmdale Circuit",
  t_palCliff: "Palmdale Cliff Edge",
  t_palCross: "Palmdale Cross Town",
  t_palExtended: "Palmdale Extended Tour",
  t_palExtended2: "Palmdale Extended Tour 2",
  t_rosDrag: "Rosamond Drag",
  t_rosRoute1: "Rosamond Route 1",
  t_rosRoute2: "Rosamond Route 2",
  t_rosRoute3: "Rosamond Route 3",
  t_rosRoute4: "Rosamond Route 4",
  t_rosRoute5: "Rosamond Route 5",
  t_rosRoute6: "Rosamond Route 6",
  t_rosRoute7: "Rosamond Route 7",
  t_rosSlalom: "Rosamond Slalom",
  t_tCircuit50: "Twisty Circuit 50/50",
  t_tCircuit60: "Twisty Circuit 60/40",
  t_tCircuit70: "Twisty Circuit 70/30",
  t_valDown: "Valley Downhill",
  t_valHairpin: "Valley Hairpin",
  t_valOff: "Valley Off Piste",
  t_valCross: "Valley River Cross",
  t_valRun: "Valley Run",
