export default {
  ...
  "p_cgNotThisTime1": "Це завдання недоступне тут",
  "p_cgNotThisTime2": "Ми вирішили не ставити цей виклик TDR. Давайте пограємо в стару школу, просто для розваги. До TDR ми всі робили це, ми можемо зробити знову. Можливо, це може бути надто важко чи ризиковано, але це просто виклик. Інші працюють нормально.",
  "p_cgNotThisTime3": "чому Ми втратили деякі соціальні способи пошуку допомоги та рішень. Цього разу ми хочемо, щоб гравці допомагали один одному, а не TDR, який пропонує всі рішення. Допомога один одному є основою кожної спільноти. Discord, Facebook, Reddit, Youtube... Їх багато. Ти не в жодній спільноті? Є вкладка з багатьма з них, знайдіть той, який вам подобається:",
  "p_cgNotThisTime4": "Щоб було зрозуміло, це не платний доступ. Навіть патрони чи модератори не можуть бачити раунди.",
  "p_cgNotThisTime5": "Сподіваюся, ви розумієте. весело провести час!"
}