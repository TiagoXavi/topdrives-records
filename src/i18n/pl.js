export default {
  ...
  "c_enginePos": "Umiejscowienie silnika",
  ...
  "c_rearEngine": "Tylne",
  "g_joinDiscord": "Dołącz do serwera TDR aby porozmawiać  o usprawnieniu twojego arkusza lub dlaczego twój arkusz został odrzucony.",
  "g_rule0": "Twój arkusz powinien mieć kontekst dla aut żeby mieć kontekst. Na przykład, takie same kolekcje, taki sam kraj, takie same opony, taka sama marka, taka sama rzadkość... Albo dowolny kontekst tak jak Hutch robi jako wymagania dla eventów/challengów.",
  ...
  "g_rule2": "Arkusz powinien porównywać auta o podobnych danych. Nie ma sensu porównywania auta z napędem na tył z wyczynowymi oponami z autem z napędem na cztery koła z oponami all-surface na suchych asfaltowych torach.",
  ...
  "g_rule7": "Arkusz nie musi mieć wszystkich czasów wpisanych, ale możesz je wypełnić to co możesz przed przesłaniem.",
