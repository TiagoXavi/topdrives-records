<template>
  <BaseCustomTag
    ...
    <div v-if="!empty" class="BaseCompItem_LayoutBox">
      ...
      <svg v-if="comp.meta && comp.meta[0] === 'Speedster'" class="BaseCompItem_MetaSpeedster" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" style="enable-background:new 0 0 95 58" viewBox="0 0 95 58">
      ...
      <svg v-if="comp.meta && comp.meta[0] === 'Twister'" class="BaseCompItem_MetaTwister" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" id="Layer_1" x="0" y="0" style="enable-background:new 0 0 95 58" version="1.1" viewBox="0 0 95 58">
