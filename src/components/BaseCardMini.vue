...
.D_Button.BaseCardMini_CarButton:active:not(.D_ButtonNoActive) {
  transform: translateY(0px);
}
.BaseCardMini_CarCard {
  position: relative;
}
.BaseCardMini_BankPhoto {
  display: flex;
  height: 42px;
  width: 68px;
...
.BaseCardMini_BankPhotoImg {
  transform: scale(1.35) translateX(-5%) translateY(-8%);
