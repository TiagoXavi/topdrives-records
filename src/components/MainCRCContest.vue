...
<script>
const votesPromise = () => import("@/database/hutch_ContestFinalVotes.json");
const realPromise = () => import("@/database/hutch_ContestRealUpDown.json");
...
export default {
  ...
  mounted() {
    ...
    .then(([_votes, _real]) => {
      let votes = _votes.default;
      let real = _real.default;
